...
import com.tv.filemanager.utils.PreferencesUtil;
import com.tv.filemanager.utils.ResUtil;
...
public final class AppHelper {
    ...
    public void initCoreApp(Application app) {
        mCoreApp = app;
        ResUtil.initResource(app);
        PreferencesUtil.initContext(app);
    }
     ...
     * 判断activity是否存在
     * @param cl Class
     * @return 存在放回true，否则返回false
     */
    public boolean existActivity(Class<?> cl) {
        if(getActivity(cl) != null) {
            return true;
        } else {
            return false;
        }
